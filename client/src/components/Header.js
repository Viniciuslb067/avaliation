        ...
        <div className="collapse navbar-collapse" id="navbarColor02">
          ...
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
              <a className="text-nav nav-link" href="" onClick={handleClickAvaliacaoInativa}>Exibir avaliações inativas</a>
            </li>
            <li className="nav-item">
              <a className="text-nav nav-link" href="" onClick={handleClickExibirUsuarios}>Exibir usuários</a>
            </li>
            <li className="nav-item">
              <a className="text-nav nav-link" href="" onClick={handleClickCriar}>Criar avaliação</a>
            </li>
            <li className="nav-item">
              <a className="text-nav nav-link" href="" onClick={handleClickCadastrar}>Cadastrar Sistema</a>
            </li>
          </ul>
